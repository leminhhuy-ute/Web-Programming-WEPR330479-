...
public class ApiDepartmentTopicController {
    ...
    public ApiResponse<List<TopicResponse>> getDepartmentTopics(
        ...
        if (targetDeptId == null && currentUser != null && accounts.departmentId() != null) {
            targetDeptId = accounts.departmentId();
        }
    ...
    public ApiResponse<TopicResponse> approveOrRejectTopic(
            ...
            @AuthenticationPrincipal CurrentUser currentUser) {
        TopicResponse topic = departmentTopicService.approveOrRejectTopic(id, request, accounts.user());
    ...
    public ApiResponse<TopicResponse> assignAdvisors(
            ...
            @AuthenticationPrincipal CurrentUser currentUser) {
        TopicResponse topic = departmentTopicService.assignAdvisors(id, request, accounts.user());
