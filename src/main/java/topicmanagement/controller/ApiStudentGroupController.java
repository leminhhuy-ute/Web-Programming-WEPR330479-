...
public class ApiStudentGroupController {
    ...
    public ApiResponse<List<StudentGroupResponse>> getMyStudentGroups(
        ...
        List<StudentGroupResponse> groups = groupService.getGroupsForLecturer(currentUser.getUser());
    ...
    public ApiResponse<StudentGroupResponse> approveOrRejectGroup(
            ...
            @AuthenticationPrincipal CurrentUser currentUser) {
        StudentGroupResponse response = groupService.approveOrRejectGroup(id, request, currentUser.getUser());
