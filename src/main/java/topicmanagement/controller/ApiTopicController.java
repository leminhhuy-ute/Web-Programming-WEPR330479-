...
public class ApiTopicController {
    ...
    public ApiResponse<List<TopicResponse>> filterTopics(
        ...
        Long createdById = (Boolean.TRUE.equals(myOnly) && currentUser != null) ? currentUser.getId() : null;
    ...
    public ApiResponse<TopicResponse> createTopic(
            ...
            @AuthenticationPrincipal CurrentUser currentUser) {
        TopicResponse created = topicService.createTopic(request, currentUser.getUser());
    ...
    public ApiResponse<TopicResponse> updateTopic(
            ...
            @Valid @RequestBody TopicRequest request,
            @AuthenticationPrincipal CurrentUser currentUser) {
        TopicResponse updated = topicService.updateTopic(id, request, currentUser.getUser());
    ...
    public ApiResponse<Void> deleteTopic(
            @PathVariable Long id,
            @AuthenticationPrincipal CurrentUser currentUser) {
        topicService.deleteTopic(id, currentUser.getUser());
